...
from convokit import Corpus, download, speaker, utterance
...
def plot_scores_general_v_specific_prompt(sp_mc, sp_rw, ge_mc, ge_rw):
    ...
    data = pd.DataFrame({
        ...
        'Method': ['Specific Prompt (McDonald argument)'] * len(metrics_names) + ['Specific Prompt (Rewrite)'] * len(metrics_names) \
